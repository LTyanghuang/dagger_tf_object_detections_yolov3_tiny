...
rootdir = "/home/ubuntu/huangyang/t4_spacework/datasets/wider_face"
gtfile = rootdir+"/wider_face_split/wider_face_val_bbx_gt.txt"
im_folder = rootdir+"/WIDER_val/images"
fwrite = open(rootdir+"/ImageSets/Main/val.txt", "w")
